...
import { addDepartment, addEmployee, editDeleteDepartment, editDeleteEmployee } from "../../actions/actions";
...
const DepartmentAdd = (props) => {
    ...
    const onSubmit = async (event) => {
        ...
        if (editData) {
            dispatch(editDeleteDepartment(sendingData));
            props.onEdit();
            props.handleCloseDialog();
        } else {
            dispatch(addDepartment(sendingData));
            props.onEdit();
            props.handleCloseDialog();
        }
    }
