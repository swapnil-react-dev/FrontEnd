...
import { editDeleteDepartment, getDepartmentList, } from "../../actions/actions";
...
const DepartmentList = () => {
    ...
    const rows = useSelector(state => state.department.department)
    const fetchData = () => {
    ...
    const [searchParam] = useState(["department", "status",]);
    ...
    const responseMessage = useSelector(state => state.department.message);
    ...
    const deleteRecord = (id) => {
        dispatch(editDeleteDepartment({ id: id, changedUpdatedValue: 'delete' }))
        setIsDelete(false);
    } 
                            ...
                            {rows && search(rows)
                                ...
                                .map((row, index) => (
                                    ...
                                    >
                                        ...
                                        <StyledTableCell align="left" className='listTableBody'>{row.department}</StyledTableCell>
